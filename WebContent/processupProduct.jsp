					...
					<header>
						...
						<%
							try{
								...
								String sql = "update product set catid=?, brand=?, prodname=?, description=?, spec1=?, spec2=?, spec3=?, "
														+"spec4=?, price=?, imgpath=? where prodid=?";
								...
								pstmt.setString(5, spec1);
								pstmt.setString(6, spec2);
								pstmt.setString(7, spec3);
								pstmt.setString(8, spec4);
								pstmt.setInt(9, Integer.parseInt(price));
								pstmt.setString(10, imgpath);
								pstmt.setInt(11, Integer.parseInt(upId));
								
								int rec = pstmt.executeUpdate();
								
								if(rec > 0){
									out.println(rec + " record(s) updated successful<br/><br/>");
