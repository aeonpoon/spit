					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="viewcategory.jsp">View Category</a></li>
					...
					<div align="center">
						...
						<%
							try{
								...
								out.println("<tr>");
								out.println("<td align='center' colspan='1'><b>Category Name</b></td>");
								out.println("<td align='right' colspan='1'><b>Actions</b></td>");
								out.println("</tr>");
								...
								while(rs.next()){
									...
									out.println("<form action='deleteCategory.jsp' method='get'>");
									out.println("<input type='hidden' name='delId' value='"+catid+"'/>");
									out.println("<input type='submit' value='Delete'/>");
									out.println("</form>");
									out.println("</td>");
									
									out.println("<td>");
									out.println("<form action='updateCategory.jsp' method='get'>");
									out.println("<input type='hidden' name='upId' value='"+catid+"'/>");
