					...
					<!-- Nav -->
						...
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="coupons.jsp">Coupons</a></li>
			...
			<div id="main-wrapper">
				...
				<!-- Content -->
					<div align="center">
						...
						%>
							<header>
							Welcome <%out.println(memDetails.getName()); %>
							<h2>Coupons</h2>
							</header>
							<form action="VoucherController" method="get">
								<b>Click here to generate your own voucher code</b><br/><br/>
							<%
								if(msg != null){
									out.println(msg+"<br/>");
								}
							%>
								<br/><input type="submit" name="genBtn" value="Generate" /><br/><br/>
								<div>
							<%
								voucherGen code = (voucherGen)session.getAttribute("code");
									if(code != null){
										out.println("Your code for the day is: <u>" + code.getStringChars() + "</u>");
									}
							%>
								<br/></div>
							</form>
