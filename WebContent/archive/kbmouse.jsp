...
<html>
	...
	<body class="left-sidebar">
		...
		<!-- Main -->
			<div id="main-wrapper">
				<div class="container">
				<h1 class="productHeader">Mouse and Keyboard</h1>
					<div class="row">
							<!-- Content -->
							<%
									try{					
										...
										String sql = "select * from product P, category C where P.catid = C.catid and C.catname='mouse and keyboard'";
										...
										while(rs.next()){
											...
											String[] spec = {"spec1", "spec2", "spec3", "spec4", "spec5", "spec6"};
											for(int i=0; i<6; i++){
