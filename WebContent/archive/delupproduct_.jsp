					...
					<div align="center">
						...
						<%
							try{
								...
								String sql = "select * from product P, category C where P.catid = C.catid";
								...
								out.println("<tr>");
								out.println("<td> <b>ProductID</b> </td>");
								out.println("<td> <b>Category</b> </td>");
								out.println("<td> <b>Brand</b> </td>");
								out.println("<td> <b>Description</b> </td>");
								out.println("<td> <b>Specification</b> </td>");
								out.println("<td> <b>Price</b> </td>");
								out.println("<td> <b>Image Path</b> </td>");
