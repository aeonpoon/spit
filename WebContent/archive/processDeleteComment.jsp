					...
					<div align="center">
						...
						<%
							try{
								...
								String connURL = "jdbc:mysql://localhost/spit?user=root&password=password";
								...
								if(rec > 0){
									out.println(rec + " comment(s) deleted successful");
									out.println("<form action='deleteComment.jsp' method='post'>");
