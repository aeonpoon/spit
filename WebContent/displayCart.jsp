					...
					%>
							...
							<nav id="nav">
								<ul>
									...
									<li class="current"><a href="displayCartController">Shopping Cart</a></li>
					...
					try{
						...
						if(memDetails == null){
							...
							if(displayCart.size() != 0){
								...
								out.println("<td align='center' colspan='2'> <b>Action</b> </td>");
								...
								for(getCart c:displayCart){
									...
									out.println("<form action='upCartController' method='post'>");
									out.println("<td align='center'>");
									out.println("<input type='text' name='quantity' value='"+c.getQuantity()+"' size='1'/>");
									out.println("</td>");
									...
									out.println("<td align='center' width='50'>");
									out.println("<form action='delCartController' method='post'>");
								...
								out.println("<td align='center'> <b>SUB TOTAL:</b> </td>" + "<b>$"+subtotal+"</b>");
								out.println("<form action='placeOrder.jsp' method='get'>");
								out.println("<br/>");
								out.println("<input type='submit' value='Summary'/>");
								out.println("<input type='hidden' name='subtotal' value='"+subtotal+"' />");
								out.println("</form>");
