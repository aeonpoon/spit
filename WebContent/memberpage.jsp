			...
			<div id="header-wrapper">
				<div id="header">
					...
					<!-- Nav -->
						...
						<nav id="nav">
							<ul>
								<li class="current"><a href="memberpage.jsp">Member Page</a></li>
			...
			<div id="main-wrapper">
				...
				<!-- Content -->
					<div align="center">
						...
						<b>Navigate through the member page to view/edit shopping cart, update details or manage coupons!</b>
					</div>
						<%
							}
						%>
