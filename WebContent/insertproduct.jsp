	...
	<body class="right-sidebar">
		...
		<!-- Main -->
			<div id="main-wrapper">
				...
				<!-- Content -->
					<div align="center">
						<form action="processinsertPro.jsp" action="post">
							<header>
							...
							<table>
									...
									<td>
										<%
											try{
												...
												out.println("<option value='' selected='selected'>Select Category</option>");
												while(rs.next()){
								...
								<tr>
									...
									<td>
										<input type="text" name="prodname" placeholder="Enter Product Name..."/><br/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="destxt" placeholder="Enter Description..."/><br/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="spec1" placeholder="Enter Specification..."/><br/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="spec2" placeholder="Enter Specification..."/><br/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="spec3" placeholder="Enter Specification..."/><br/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="spec4" placeholder="Enter Specification..."/><br/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="imgpath" placeholder="Enter Image Path..."/><br/>
									</td>
								</tr>
