					...
					<div align="center">
						...
						<form action="LoginController" method="post">
							<table>
								<tr>
									<td>Login ID: </td>
									<td><input type="text" name="loginid" placeholder="Enter your login ID!"/></td>
								</tr>
								...
								<tr>
									<td></td>
									<td style="padding: 10px;"><h4 style="text-decoration:underline;"><a href="forgetpass.jsp">Forget Password</a></h4></td>
								</tr>
